      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <section className="rounded-2 border border-bd-1 bg-sf-1 flex flex-col items-center justify-center gap-4 p-6">
          <div className="w-[220px] h-[220px] rounded-3 border border-dashed border-bd-3 bg-sf-0 flex flex-col items-center justify-center gap-2 text-center px-4">
            ...
            <span className="text-apoio text-tx-3">O QR Code aparece aqui quando a conexão estiver disponível.</span>
          </div>
          ...
          {/* Sem `title`: em botão desabilitado ele nunca aparece, e o parágrafo
              acima já explica que falta configurar a uazapi. */}
          <Botao variante="neutro" tamanho="sm" disabled icone={<RefreshCw size={15} />}>
            Gerar nova sessão
          </Botao>
        </section>
      </div>
